...
#define LETIMER0_period 		    4                // LED period
#define LETIMER0_LEDontime	        0.004              // excitation time
...
// i2c MMA ports
#define port_MMA_power				gpioPortD       //D0
#define port_MMA_SDA				gpioPortC
#define port_MMA_SCL				gpioPortC

// i2c TSL ports
#define port_TSL_SDA				gpioPortD        // D6
#define port_TSL_SCL				gpioPortD        // D7
#define port_i2c_interrupt			gpioPortD
#define port_TSL_power				gpioPortD       //D2
...
#define I2C1_START    0x01
#define I2C1_STOP     0x02
...
#define Addr_ADCval   0xEC					// Address for reading ADC values for both ADCs
